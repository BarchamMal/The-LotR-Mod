package barch.the_lotr_mod.Carcases;
...
import static barch.the_lotr_mod.TheLotRMod.*;
...
public class AnimalByproducts {
    ...
    public static void onInitialize() {
        ...
        ItemGrouper.GroupItem(COLORFUL_FISH_SCALES, new ItemGrouped[]{new ItemGrouped(BYPRODUCTS_GROUP, FISH_SCALES)});
