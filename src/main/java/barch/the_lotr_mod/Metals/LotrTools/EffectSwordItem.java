...
/**
    A {@link SwordItem} that deals an effect to during the {@link EffectSwordItem#postHit(ItemStack, LivingEntity, LivingEntity)} method.
...
public class EffectSwordItem extends SwordItem {
     ...
     */
    public EffectSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, StatusEffect statusEffect, int effectTime, Settings settings) {
